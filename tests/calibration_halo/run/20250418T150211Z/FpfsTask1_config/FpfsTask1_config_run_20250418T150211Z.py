...
# whether to use truth catalog as detection
config.use_truth_detection=False

# whether to use dm catalog as detection
config.use_dm_detection=False
...
# name for connection truthCatalog
config.connections.truthCatalog='{coaddName}Coadd_truthCatalog'
...
config.connections.coaddName='sim_0_rot0_'
