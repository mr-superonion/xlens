...
# Layout of the galaxy distribution (random, grid, hex)
config.simulator.layout='random'

# galaxy type
config.simulator.galaxy_type='catsim2017'

# The ratio to extend for the size of simulated image
config.simulator.extend_ratio=1.06

# separation distance (arcsec) between galaxies (for grid and hex)
config.simulator.sep=11.0

# Whether to keep the order in truth catalog
config.simulator.order_truth_catalog=False
...
# whether to force galaxies at pixel center
config.simulator.force_pixel_center=False
