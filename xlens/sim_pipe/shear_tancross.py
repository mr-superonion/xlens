...
from ..simulator.multiband import MultibandSimShearTanCrossTask


class MultibandSimShearTanCrossPipeConnections(
    PipelineTaskConnections,
...
class MultibandSimShearTanCrossPipeConfig(
    PipelineTaskConfig,
    pipelineConnections=MultibandSimShearTanCrossPipeConnections,
):
    simulator = ConfigurableField(
        target=MultibandSimShearTanCrossTask,
...
class MultibandSimShearTanCrossPipe(PipelineTask):
    _DefaultName = "MultibandSimShearTanCrossPipe"
    ConfigClass = MultibandSimShearTanCrossPipeConfig

    def __init__(self, **kwargs: Any) -> None:
        super().__init__(**kwargs)
        assert isinstance(self.config, MultibandSimShearTanCrossPipeConfig)
