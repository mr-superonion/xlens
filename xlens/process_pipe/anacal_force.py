...
det_colnames = [
    "ra", "dec", "flux", "dflux_dg1", "dflux_dg2", "dflux_dj1", "dflux_dj2",
    "t", "dt_dg1", "dt_dg2", "dt_dj1", "dt_dj2",
    "a1", "da1_dg1", "da1_dg2", "da1_dj1", "da1_dj2",
    "a2", "da2_dg1", "da2_dg2", "da2_dj1", "da2_dj2",
    "e1", "de1_dg1", "de1_dg2", "de1_dj1", "de1_dj2", "e2",
    "de2_dg1", "de2_dg2", "de2_dj1", "de2_dj2",
    "x1", "dx1_dg1", "dx1_dg2", "dx1_dj1", "dx1_dj2", "x2", "dx2_dg1",
    "dx2_dg2", "dx2_dj1", "dx2_dj2",
...
class AnacalForcePipe(PipelineTask):
    ...
    def run_one_band(
        ...
        **kwargs,
        ...
        assert isinstance(self.config, AnacalForcePipeConfig)
        detection = rfn.repack_fields(detection[det_colnames])
