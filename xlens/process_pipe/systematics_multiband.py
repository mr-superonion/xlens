...
class SystematicsMultibandPipeConnections(
    ...
    outputNoiseCorr = cT.Output(
        ...
        name="{outputCoaddName}_coadd_systematics_noisecorr",
        dimensions=("tract", "patch", "band", "skymap"),
        storageClass="ImageF",
    )
    outputPsfCentered = cT.Output(
        doc="noise correlation function",
        name="{outputCoaddName}_coadd_systematics_psfcentered",
        dimensions=("tract", "patch", "band", "skymap"),
        storageClass="ImageF",
    )
    outputStarCentered = cT.Output(
        doc="noise correlation function",
        name="{outputCoaddName}_coadd_systematics_starcentered",
        dimensions=("tract", "patch", "band", "skymap"),
        storageClass="ImageF",
    )
